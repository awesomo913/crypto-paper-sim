...
from paper_sim.core import buy_all, buy_all_with_cost_factor, buy_spend, rsi_last, sell_all
...
class PaperSimCoreTests(unittest.TestCase):
    ...
    def test_buy_and_sell_accounting(self) -> None:
        usdt, btc = buy_all_with_cost_factor(usdt=1000.0, btc=0.0, price=100.0, fee=0.0007, cost_factor=0.999)
        self.assertEqual(usdt, 0.0)
        self.assertAlmostEqual(btc, (999.0 * (1.0 - 0.0007)) / 100.0)
        _, btc_full = buy_all(usdt=1000.0, btc=0.0, price=100.0, fee=0.0007)
